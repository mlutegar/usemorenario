    ...
    <div class="{% if card_collapse %}js-card-header-collapse card-header-collapse {% endif %}card-header">
        ...
        {% if card_collapse %}
            <span class="js-card-collapse-toggle card-collapse-toggle {% if card_active %}active{% endif %}">
                <svg class="js-card-collapse-icon icon-inline icon-w-14 icon-lg svg-icon-text"><use xlink:href="#plus"/></svg>
                <svg class="js-card-collapse-icon icon-inline icon-w-14 icon-lg svg-icon-text" style="display: none;"><use xlink:href="#minus"/></svg>
            </span>
        {% endif %}
    </div>
