{% if section_select == 'slider' %}
	...
	<section class="js-main-slider-section section-slider-home{% if not settings.slider_full %} section-home{% endif %}" data-store="home-slider" data-transition="fade-in" {% if head_transparent_section %}data-header-type="transparent-on-section"{% endif %}>
