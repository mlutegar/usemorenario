{% if settings.welcome_message %}
	...
	<section class="section-home section-welcome {% if settings.welcome_colors %} section-home-color section-welcome-home-colors{% endif %}{% if welcome_animated %} section-welcome-animated{% endif %}" data-store="home-welcome-message">
