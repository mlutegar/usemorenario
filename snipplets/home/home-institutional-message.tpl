{% if settings.institutional_subtitle or settings.institutional_message or settings.institutional_text %}
	...
	<section class="section-home section-institutional {% if settings.institutional_colors and settings.institutional_full %}section-institutional-home-colors section-home-color{% endif %}" data-store="home-institutional-message">
		<div class="container">
