{% if settings.video_embed %}
    ...
    <section class="js-section-video section-video-home position-relative{% if not has_video_full %} section-home{% endif %}" data-store="home-video" data-transition="fade-in-up" {% if settings.head_transparent %}data-header-type="transparent-on-section"{% endif %}>
