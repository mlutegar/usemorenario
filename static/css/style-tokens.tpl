...
:root {
  ...
  --header-transparent-foreground-opacity-20: {{ header_transparent_foreground }}{{ opacity_20 }};
  ...
  {% set title_weight = settings.headings_bold ? '600' : '400' %}
